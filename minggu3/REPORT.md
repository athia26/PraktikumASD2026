...
```
    ...
    - Baris pertama melakukan instansiasi untuk menciptakan object baru dari class Mahasiswa05() lalu menyimpannya di indeks ke-0 dalam array. 
    lalu baris ke 2 sampai 5 kode melakukan pengisian atribut nim, nama, kelas, dan ipk pada object tersebut. 
